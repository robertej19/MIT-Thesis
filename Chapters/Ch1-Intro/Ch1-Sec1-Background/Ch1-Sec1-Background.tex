\section{Exploring Structure through Scattering}\label{ch1:sec1:background}
    ...
    \subsection{Inelastic Scattering and Parton Distribution Functions}
        ...
        The cross section for inelastic scattering has several peaks at various proton resonances, as indicated in the top sketch of Fig. \ref{fig:ScatteringvsW}. Continuing to higher energy transfers we reach the `Deep Inelastic Scattering` regime, defined by kinematics as $Q^2$ $>$ 1 GeV$^2$ and W$^2$ $>$4 GeV$^2$.
        ...
        \begin{equation}\label{eq:xB}
            x = \frac{Q^2}{2p_p\cdot q} = \frac{Q^2}{Q^2+W^2-m_p^2}
        ...
        \begin{equation}\label{eq:y}
            y = \frac{p_p \cdot q}{p_p \cdot p_e} = \frac{\nu}{E_{beam}} =  1 - \frac{E_{e'}}{E_{beam}}
       ...
       \myequations{\quad $F_2$ structure function in terms of PDFs}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.7\textwidth]{Chapters/Ch1-Intro/Ch1-Sec1-Background/pics/inelastic-ep/protF2.png}
