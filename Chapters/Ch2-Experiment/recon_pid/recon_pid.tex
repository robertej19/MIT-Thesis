...
\subsection{Particle Identification}\label{sec:pid}
    ...
    The main uses are summarized in \tabref{tab:detector_components}.
 
    \begin{table}[h]
        \centering
        \begin{tabular}{c|c|c}
            \hline
            System & Detector  & Utility for this Analysis \\
            \hline
            ...
            \hline
        \end{tabular}
        \caption{Description of the components of the CLAS12 detector system and their primary usage in this work. Modified from \parencite{Lee2022MeasurementDetector}}
    ...
    \subsubsection*{pion}
        ...
        \begin{figure}[hbt]
            ...
            \caption{Combined figure. (a) Before exclusivity cuts. (b) After exclusivity cuts.}
...
\subsection{Data Storage and Formatting}\label{sec:filtering}
    ...
    \begin{figure}
        ...
        box/.style={rectangle, draw, minimum size=#1, align=center}]
            ...
            \node [box=1.5cm, fill=mypurp, inner sep=0.4cm] (dvip) at (events.center) {};
            \node [anchor=north, yshift=-0.5cm, text=white] at (dvip.north) {\textbf{\textcolor{white}{1 GB}}};
        \end{tikzpicture}
