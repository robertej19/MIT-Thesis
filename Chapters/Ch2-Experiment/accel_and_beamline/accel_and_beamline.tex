...
\subsection{Accelerator Facility}
    ...
    \subsection{Hall B Beamline}
        ...
        \hline
        \end{tabular}
        \caption{Beam properties entering Hall B}
    ...
    \begin{figure}[ht]
        ...
        \begin{minipage}[b]{0.3\linewidth}
            \subfloat[Upstream (top) and downstream (bottom) view of \Moller polarimeters \parencite{Joo2002ElectronPolarimeter}.]{\label{fig:moller}\includegraphics[width=\linewidth]{Chapters/Ch2-Experiment/accel_and_beamline/pics/hallB/hall-b-poll-2.jpg}}
        \end{minipage}
        \hfill
        \begin{minipage}[b]{0.3\linewidth}
