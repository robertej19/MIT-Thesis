...
\subsubsection{Accelerator Facility}
    ...
    \begin{minipage}[b]{\linewidth}
    \centering
    \subfloat[]{\label{fig:klystron}\includegraphics[width=0.45\textwidth]{Chapters/Ch2-Experiment/accel_and_beamline/pics/CEBAF/klystron.png}}
    \subfloat[]{\label{fig:magnets}\includegraphics[width=0.45\textwidth]{Chapters/Ch2-Experiment/accel_and_beamline/pics/CEBAF/magnets2.png}}
    \end{minipage}
...
\subsubsection{Detector Hall B Beamline}
