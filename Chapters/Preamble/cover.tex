...
\title{Measurement of the Deeply Virtual Neutral Pion Electroproduction Cross Section off the Proton at 10.6 GeV using the CLAS12 Detector}
...
\prevdegrees{B.S. Chem. Eng., University of Massachusetts, Amherst (2017) \\
                   B.S. Physics, University of Massachusetts, Amherst (2017)}
\department{Department of Physics}

% If the thesis is for two degrees simultaneously, list them both
% separated by \and like this:
% \degree{Doctor of Philosophy \and Master of Science}
\degree{Doctor of Philosophy in Physics, Statistics, and Data Science}
...
\begin{abstractpage}
\input{Chapters/Preamble/abstract.tex}
\end{abstractpage}

\clearpage

\input{Chapters/Preamble/acknowledgements.tex}
